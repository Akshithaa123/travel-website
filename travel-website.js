document.querySelectorAll('[data-toggle~="navbar-submenu-content"]').forEach(el => {
    el.addEventListener('click', function(e){
        e.preventDefault();
        this.closest('.navbar-submenu-wrapper').querySelectorAll('[data-toggle~="navbar-submenu"]').forEach(item => {
            item.classList.remove('active');
        });
        this.classList.add('active');
        this.closest('.navbar-submenu-wrapper').querySelectorAll('.navbar-submenu-content-wrapper').forEach(item => {
            item.classList.remove('active');
        });
